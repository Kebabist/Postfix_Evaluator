...
template <class T>
void Queue<T>::append(const T* data, const size_t length) {
...
template <class T>
typename Queue<T>::Node* Queue<T>::getNode(const size_t index) {
...
template <class T>
T Queue<T>::getData(const size_t index) {
    return *(getNode(index)->data);
}

template <class T>
void Queue<T>::remove(const size_t index) {
    if (!listCheck()) return;
...
template <class T>
bool Queue<T>::inList(const T data) {
